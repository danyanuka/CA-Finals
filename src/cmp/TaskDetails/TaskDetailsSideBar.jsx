export function TaskDetailsSideBar() {
    return <aside className="task-details-sidebar">
        <div className="task-details-sidebar-prop">
            ...
            <button className="td-btn task-details-sidebar-members">
                <i className="icon-task-members"></i>
                Member
            </button>
            <button className="td-btn task-details-sidebar-labels">
                <i className="icon-task-labels"></i>
                Labels
            </button>
            <button className="td-btn task-details-sidebar-checklists">
                <i className="icon-task-checklist"></i>
                Checklists
            </button>
            <button className="td-btn task-details-sidebar-dates">
                <i className="icon-task-dates"></i>
                Dates
            </button>
            <button className="td-btn task-details-sidebar-attachments">
                <i className="icon-task-attachments"></i>
                Attachments
            </button>
            <button className="td-btn task-details-sidebar-cover">
        ...
        <div className="task-details-sidebar-actions">
            ...
            <button className="td-btn task-details-sidebar-template">
                <i className="icon-task-make-template"></i>
                Make template
            </button>
            <button className="td-btn task-details-sidebar-archive">
                <i className="icon-task-archive"></i>
                Archive
            </button>
            <button className="td-btn task-details-sidebar-share">
