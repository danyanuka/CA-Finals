...
export function RichTextBox({ rawData, onSaveData }) {
    ...
    const toolbarProps = {
        ...
        inline: {
            ...
            bold: { icon: "/icons/text-bold.svg", className: "i-bold" },
            italic: { icon: "/icons/text-italic.svg", className: "i-italic" },
        },
        list: {
            ...
            unordered: { icon: "/icons/textbox-uolist.svg", className: "i-uolist" },
        ...
        link: {
            ...
            link: { icon: "/icons/textbox-link.svg", className: "i-link" },
        },
        image: {
            icon: "/icons/textbox-image.svg",
